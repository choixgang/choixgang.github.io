  ...
  document.querySelectorAll(".navbar-toggler").forEach(function (e) {
    e.addEventListener("click", function (e) {
      var t = e.target.closest("nav"),
        o = t.querySelector("ul.site-navigation"),
        l = o.parentNode.innerHTML;
      if (o.parentNode.matches(".fullscreen-nav, .sidebar-nav"))
        if (
          (e.stopPropagation(),
          o.parentNode.classList.add("nav-special"),
            ...
            (function () {
              ...
              document
                ...
                : document
                    ...
                    .classList.contains("nav-invert") && (o = "fadeInLeft");
              document
                .querySelectorAll(".blocsapp-special-menu blocsnav li")
                .forEach((l) => {
                  l.parentNode.classList.contains("dropdown-menu")
                    ? l.classList.add.apply(l.classList, ["animated", "fadeIn"])
                    : ((e += t),
                      l.classList.add.apply(l.classList, ["animated", o]),
                      l.setAttribute("style", "animation-delay:" + e + "ms"));
                });
            })(),
            document
              .querySelector("blocsnav")
    ...
    delegateSelector("body", "click", ".blocsapp-special-menu a", function (t) {
      t.target.closest(".dropdown-toggle") || e();
    }),
    delegateSelector(
      "body",
      "mousedown touchend",
...
function setUpNavExtras() {
  function e(e) {
    ...
    if (t) {
      var o = e.parentNode.querySelector(".dropdown-menu");
      if (
        !t.parentNode.classList.contains("navbar-nav") &&
        !e.closest(".nav-special")
      ) {
        var l = t.offsetWidth - 2,
          n = e.parentNode.querySelector(".dropdown-menu").offsetWidth;
        o.classList.remove("submenu-left"),
          0 == n && (n = 160),
          t.getBoundingClientRect().left + n + l > window.innerWidth &&
            o.classList.add("submenu-left");
      }
    }
  }
  delegateSelector(
...
function scrollToTarget(e, t) {
  var o = window.scrollY || document.documentElement.scrollTop,
    ...
    n = 1e3,
    i = 0;
  if (0 == e) i = t.closest(".bloc").offsetHeight;
  else if (2 == e) i = document.documentElement.scrollHeight;
  else if (1 != e) {
    i = document.querySelector(e).getBoundingClientRect().top + window.scrollY;
    var a = document.querySelector(".sticky-nav");
    a && (i -= a.offsetHeight);
  }
  t.matches("[data-scroll-speed]") &&
    (n = parseInt(t.getAttribute("data-scroll-speed")));
  var c = Math.max(0.1, Math.min(Math.abs(o - i) / n, 0.8));
  !(function e() {
    var t = (l += 1 / 60) / c,
      n = Math.sin(t * (Math.PI / 2)),
      a = i;
    t < 1 && (requestAnimFrame(e), (a = o + (i - o) * n)),
      window.scrollTo(0, a);
  })();
}
function stickyNavToggle() {
  var e = document.querySelector(".sticky-nav");
  if (e) {
    var t = e.getBoundingClientRect().top + window.scrollY,
      o = ["sticky"],
      l = document.querySelector(".page-container"),
      n = e.classList.contains("fill-bloc-top-edge");
    n &&
      ((l = document.querySelector(
        ".fill-bloc-top-edge.sticky-nav"
      ).parentNode),
      (o = ["sticky", "animated", "fadeIn"])),
      e.classList.contains("sticky") &&
        (t = e.getAttribute("data-original-offset")),
      (window.pageYOffset || document.documentElement.scrollTop) > t
        ? e.classList.contains("sticky") ||
          (e.classList.add.apply(e.classList, o),
          e.setAttribute("data-original-offset", t),
          (t = e.offsetHeight),
          n &&
            ((e.style.background = getBlocBgColor(l)),
            (t += parseInt(
              window.getComputedStyle(l, null).getPropertyValue("padding-top")
            ))),
          (l.style.paddingTop = t + "px"))
        : e.classList.contains("sticky") &&
          (e.classList.remove.apply(e.classList, o),
...
function getBlocBgColor(e) {
  var t = window.getComputedStyle(e, null),
    o = t.getPropertyValue("background-color"),
    l = t.getPropertyValue("background-image");
  return (
    e.classList.contains("b-parallax") &&
      (o = window
        .getComputedStyle(e.querySelector(".parallax"), null)
        .getPropertyValue("background-color")),
    "rgba(0, 0, 0, 0)" == o && -1 == l.indexOf("gradient") && (o = "#FFFFFF"),
    o
  );
}
function hideAll() {
...
function inViewCheck() {
  [].slice
    .call(document.querySelectorAll(".hideMe"), 0)
    .reverse()
    .forEach((e) => {
      var t = e.getBoundingClientRect().top + window.scrollY,
        o = t + e.offsetHeight,
        l = window.pageYOffset + window.innerHeight;
      if ((e.offsetHeight > window.innerHeight && (o = t), o < l)) {
        var n = e.className.replace("hideMe", "animated");
        (e.style.visibility = "hidden"),
          e.removeAttribute("class"),
          setTimeout(function () {
            (e.style.visibility = "visible"), e.setAttribute("class", n);
          }, 0.01);
        [
          "webkitAnimationEnd",
          "mozAnimationEnd",
          ...
          window.addEventListener(t, function (t) {
            e.classList.contains("animLoopInfinite") ||
              e.classList.remove(e.getAttribute("data-appear-anim-style"));
          });
        });
      }
    });
  ...
  document.querySelectorAll("[data-toggle-visibility]").forEach(function (e) {
    e.addEventListener("click", function (e) {
      ...
      var t = e.currentTarget.getAttribute("data-toggle-visibility"),
        o = [t];
      -1 != t.indexOf(",") && (o = t.split(",")),
        o.forEach(function (e) {
          !(function (e) {
            if (e) {
              if (
                (e.classList.contains("toggled-item") ||
                  e.classList.add("toggled-item"),
                "0px" ==
                  window.getComputedStyle(e, null).getPropertyValue("height") ||
                  e.classList.contains("object-hidden"))
              ) {
                e.classList.remove("object-hidden"),
                  e.style.removeProperty("display"),
                  (e.style.height = "auto");
                var t = e.clientHeight + "px";
                (e.style.height = "0px"),
                  e.offsetHeight,
                  e.classList.remove("toggled-item-hidden"),
                  setTimeout(function () {
                    e.style.height = t;
                  }, 0),
                  setTimeout(function () {
                    (e.style.minHeight = t), e.style.removeProperty("height");
                  }, 360);
              } else
                (e.style.height = e.scrollHeight + "px"),
                  e.offsetHeight,
                  e.style.removeProperty("min-height"),
                  e.classList.add("toggled-item-hidden"),
                  window.setTimeout(function () {
                    (e.style.height = "0"),
                      0 == e.style.height && (e.style.display = "none");
                  }, 0);
              reCalculateParallax();
            }
  ...
  document.querySelectorAll("[data-toggle-class-target]").forEach(function (e) {
    e.addEventListener("click", function (e) {
      ...
      if (o.length) {
        ...
        else document.getElementById(t).classList.toggle(o);
        reCalculateParallax();
      }
    });
  });
...
function setUpLightBox() {
  function e() {
    ...
    var l = targetJSLightbox.getAttribute("data-lightbox");
    if (".mp4" == l.substring(l.length - 4)) {
      var n = "";
      1 == targetJSLightbox.getAttribute("data-autoplay") && (n = "autoplay"),
      ...
      var i = targetJSLightbox.getAttribute("data-caption");
      i && ((t.innerHTML = i), (t.style.display = "block"));
    }
    var a = document.querySelector(".prev-lightbox"),
      c = document.querySelector(".next-lightbox");
    (a.style.display = "block"), (c.style.display = "block");
    var s = document.querySelectorAll("a[data-lightbox]");
    if (targetJSLightbox.getAttribute("data-gallery-id")) {
      var r = targetJSLightbox.getAttribute("data-gallery-id");
      s = document.querySelectorAll('a[data-gallery-id="' + r + '"]');
    }
    var d = Array.from(s).indexOf(targetJSLightbox);
    0 == d
      ? ((a.style.display = "none"),
        1 == s.length && (c.style.display = "none"))
      : d == s.length - 1 && (c.style.display = "none");
  }
  window.targetJSLightbox,
    document.querySelectorAll("[data-lightbox]").forEach(function (t) {
      t.addEventListener("click", function (o) {
        o.preventDefault(), (targetJSLightbox = t);
        var l = targetJSLightbox.getAttribute("data-lightbox"),
          n = targetJSLightbox.getAttribute("data-caption"),
          i = targetJSLightbox.getAttribute("data-frame"),
          a = "",
          c = "";
        1 == targetJSLightbox.getAttribute("data-autoplay") && (c = "autoplay");
        var s = targetJSLightbox.querySelector("img");
        s && s.classList.contains("img-protected") && (a = "img-protected");
        var r = document.querySelector("#lightbox-modal");
        r && r.remove();
        var d =
          ...
          u =
            ...
            '" src="' +
            l +
            '"><div id="lightbox-video-container" class="ratio ratio-16x9"><video controls ' +
            c +
            ' class="embed-responsive-item"><source id="lightbox-video" src="' +
            l +
        ...
        document.body.insertAdjacentHTML("beforeend", u),
          document
            ...
            .forEach(function (t) {
              t.addEventListener("click", function (o) {
                o.preventDefault();
                var l = document.querySelectorAll("a[data-lightbox]");
                if (targetJSLightbox.getAttribute("data-gallery-id")) {
                  var n = targetJSLightbox.getAttribute("data-gallery-id");
                  l = document.querySelectorAll(
                    'a[data-gallery-id="' + n + '"]'
                  );
                }
                var i = Array.from(l).indexOf(targetJSLightbox) + 1;
                t.classList.contains("prev-lightbox") && (i -= 2),
                  i > -1 && l.length > i && ((targetJSLightbox = l[i]), e());
              });
            }),
          (function () {
            ...
            if (e) {
              let o = 0,
                ...
                i = 0;
              function t() {
                var e = document.querySelector(".prev-lightbox"),
                  t = document.querySelector(".next-lightbox");
                n <= o && "none" != t.style.display && t.click(),
                  n >= o && "none" != e.style.display && e.click();
              }
              e.addEventListener(
                "touchstart",
                function (e) {
                  (o = e.changedTouches[0].screenX),
                    (l = e.changedTouches[0].screenY);
                },
                !1
              ),
                e.addEventListener(
          ...
          (r = document.querySelector("#lightbox-modal")),
          "fullscreen-lb" == i &&
            (r.classList.add("fullscreen-modal"),
          ...
          e();
        var g = new bootstrap.Modal(
          document.querySelector("#lightbox-modal"),
          {}
        );
        if ((g.show(), a.length)) {
          var p = document.querySelector("#lightbox-modal .img-protected");
...
function reCalculateParallax() {
  if (document.querySelector(".b-parallax")) {
    var e = document.querySelectorAll(".parallax__container .parallax");
    e.forEach((e) => {
      e.style.height = "100%";
    }),
      setTimeout(function () {
...
function scrollToPolyFill() {
  ...
  if (
    ...
    (e.scroll = e.scrollTo =
      ...
      (l.prototype.scrollIntoView = function () {
        if (!0 !== r(arguments[0])) {
          var o = (function (e) {
              for (; e !== t.body && !1 === g(e); ) e = e.parentNode || e.host;
              return e;
            })(this),
          ...
          o !== t.body
            ? (m.call(
                this,
                o,
                o.scrollLeft + n.left - l.left,
                o.scrollTop + n.top - l.top
              ),
  ...
  function u(t, o) {
    var l = e.getComputedStyle(t, null)["overflow" + o];
  ...
  function p(t) {
    ...
    (c = s = s > 1 ? 1 : s),
      ...
      (l = t.startX + (t.x - t.startX) * o),
      (i = t.startY + (t.y - t.startY) * o),
      t.method.call(t.scrollable, l, i),
      (l === t.x && i === t.y) || e.requestAnimationFrame(p.bind(e, t));
  }
  function m(o, l, n) {
    var c,
      r,
    ...
    o === t.body
      ? ((c = e),
        ...
        (u = i.scroll))
      : ((c = o), (r = o.scrollLeft), (d = o.scrollTop), (u = s)),
      p({
        scrollable: c,
        method: u,
        startTime: g,
...
function delegateSelector(e, t, o, l) {
  t.split(" ").forEach((t) => {
    var n = document.querySelectorAll(e);
    [].forEach.call(n, function (e, n) {
      e.addEventListener(t, function (e) {
        e.target.matches(o) && l(e);
      });
    });
  });
}
    ...
    this.classList.contains("has-child-dropdown-show") &&
      ...
      s.clickEvent &&
        s.clickEvent
          .composedPath()
          .some(
            (s) => s.classList && s.classList.contains("dropdown-toggle")
          ) &&
        s.preventDefault(),
      s.stopPropagation();
  });
...
(function () {
  ...
  var parentDirectory = scriptUrl.pathname.substring(
    0,
...
function changeButtonText() {
  var button = document.getElementById("더보기");

  if (button.innerText === "사진더보기") {
    button.innerText = "접기";
  } else if (button.innerText === "접기") {
    button.innerText = "사진더보기";
  }
}
...
function makeTimer() {
  ...
  const leftDay = new Date("March 22, 2025 13:00:00 UTC+09:00"); //디데이 지정
  ...
  (diffDays == 0 ? DDay.innerText='오늘입니다' 
  : diffDays < 0 ? DDay.innerText = `D${diffDays}` 
  : DDay.innerText = `D+${diffDays}`);
}
...
// 카카오톡 공유하기 openApi 
Kakao.init('254ba08a0ab78fa5a9f9bbdc987d63d1');
// key 값을 가져오는지 확인 > console.log(Kakao.isInitialized());
function shareMessage() {

    Kakao.Link.createScrapButton({
      container: '#kakao-link-btn',
      requestUrl: 'https://love-without-end.com',
      templateId : 114050
  });
...
function btnClick() {
  const mydiv = document.getElementById('delete-info');
